...
class Businesssubject(
    ...
    constructor(
        subject: Subject,
        identitydocument: Identitydocument, identitynumber: String, businessname: String?,
        subjectrolcategory: Subjectrolcategory, startdate: Date?, phone: String?,
        address: String?, districtid: Int?, email: String?, city: String?
